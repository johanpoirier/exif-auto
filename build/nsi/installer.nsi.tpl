...
########
!addincludedir "build/nsi/  include"
...
Section
  ...
  ########
  ${registerExtension} "$INSTDIR\${APP_NAME}.exe" "epub" "epub for TEA Time"
  ${registerExtension} "$INSTDIR\${APP_NAME}.exe" "care" "epub with CARE for TEA Time"
  ########
...
Section "Uninstall"
  ...
  ########
  ${unregisterExtension} "epub" "epub for TEA Time"
  ${unregisterExtension} "care" "epub with CARE for TEA Time"
  ########
